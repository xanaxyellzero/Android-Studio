...
public class MenuMinuman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter = new ArrayAdapter(MenuMinuman.this, R.layout.support_simple_spinner_dropdown_item, tipe);
        pembayaran.setAdapter(adapter);
    }

    public void BACK(View view) {
        Intent intent = new Intent(MenuMinuman.this,MainActivity.class);
    ...
    public void CART(View view) {
        Intent intent = new Intent(MenuMinuman.this, cart.class);
        startActivity(intent);
    }
}